...
async def fetch_tracked_channels(
    itn: discord.Integration, input_channel: str, include_unknown: bool
    ...
    async with connect_readonly(
        ...
        async with db.cursor() as cursor:
            ...
            async for row in cursor:
                ...
                if (channel is None and input_channel) or (
                    channel is not None and input_channel not in channel.name.lower()
                ):
                    continue
